...
<script language="javascript">
	...
	if(strPage == "page1")
	{
	document.form1.action="CUD/create_so_doc.php";
	}
...
<div class="row-fluid sortable">		
	...
	<div class="container">
<a href="sd_sale.php?id=<?= $custo_id ?>" class="btn btn-danger" role="button">Back</a>
	...
	<p></p>
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Create Sale order</h2>
					</div>
						...
						<p> </p>
						 ...
						 <div class="form-group">
							 ...
							 <label for="usr">
							  ...
							  <label for="usr">
								Quotation number: <input type="text" class="form-control" id="cusnum" disabled placeholder="<?php echo 'QT'.$inq_id ?>">   
							 </label> 
							<label for="usr">
