...
<script language="javascript">
	...
	if(strPage == "page1")
	{
	document.form1.action="mm_qt_display.php";
	}
	if(strPage == "page2")
	{
...
<!--		<button type="button" class="btn btn-primary" id="Display" value="2">Create</button>   -->
  ...
  <button type="button" class="btn btn-primary" id="Create" value="3">Display</button>   -->   
	...
	<div class="box span12" style="margin-left: 0px;">
					<form action="mm_qt_next.php" method="post">
					...
					<div class="box-content"  	> 
						<label for="usr">
							...
							<p></p>
								<button type="submit" class="btn btn-primary btn-lg" role="button" id="copyqt">Copy to Quotation</button>
				...
				<form action="mm_qt_display.php" method="post">
						<div style="display: none">
					...
					<div class="box-content"> 
						 ...
						 <div class="form-group">
							...
							<div class="form-group">
  								<label for="sel1">Quotation List:</label>
  									<select name="rfq_number" onchange="showCustomer(this.value)">
								<?php
									include("includes/connection.php");

									$sql2 = "SELECT * FROM document_mm WHERE vendor_id = '$vendor_id'&& doc_mm_type_id=5 ";
									$result2=mysqli_query($connect,$sql2); //rs.open sql,con
		  ...
		  <table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn glyphicon glyphicon-ok" id="add_customer" href="mm_before_qt.php?id=<?= $row['vendor_id'] ?>" >
