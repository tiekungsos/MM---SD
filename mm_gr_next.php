						 ...
						 <div class="form-group">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td>EA</td>
								<td><a class="btn btn-danger" onclick="return confirmDel()" href="CUD/delete_item_gr.php?delID=<?php echo $row2['line_item_mm_id'];?>">
							...
							?>
								...
								<input type="hidden" name="vendor_id" value="<?= $vendor_id ?>">
							 	...
							 	<button type="submit" class="btn btn-primary btn-lg" onClick="JavaScript:fncSubmit('page1')">Post</button>
