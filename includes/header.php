...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js"></script>
	...
	function insertMat(){
		var mat_num = document.getElementById("mat_num_insert").value;
		document.getElementById("show_mat_number").innerHTML = mat_num;
	}
...
////			$("#create3").css('display', 'block');
////			}			
////			if(value=='2'){
////			$("#create1").css("style", "display:none");	
////			$("#create2").css("style", "display:block");
////			$("#create3").css("style", "display:none");
//			}
