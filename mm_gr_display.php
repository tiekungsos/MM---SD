<?php
    ...
    $_SESSION['po_qty']=0;
    $gr_number="GR$rfq_number";
    $po_number="PO$rfq_number";
...
<script language="javascript">
	...
	if(strPage == "page1")
	{
	document.form1.action="CUD/create_gr_doc.php";
	}

	if(strPage == "page2")
	{
	document.form1.action="CUD/input_qty_po.php";
	}
...
<a href="mm_before_gr.php?id=<?= $vendor_id ?>" class="btn btn-danger" role="button">Back</a>
...
<div class="box span12" style="margin-left: 0px;">
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Create Goods Receipt</h2>
					</div>
					<div class="box-content"  	> 
						 ...
						 <div class="form-group">
							 ...
							 <br/>
							 <label for="usr">Goods Receipt id : <input type="text" class="form-control" value="<?= $gr_number ?>" disabled  >
								<input type="hidden" name="gr_number" value="<?= $gr_number ?>" >
							...
							<label for="usr">PO number : <input type="text" class="form-control" value="<?= $po_number ?>" disabled  >
								<input type="hidden" name="rfq_number" value="<?= $po_number ?>" >
						 ...
						 <div class="form-group">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td>
									<form action="CUD/input_qty_gr.php" method="post">
								...
								<td>EA</td>
								<td><span class="glyphicon glyphicon-ok"></span><?php $sql5 = "SELECT * FROM document_mm WHERE doc_mm_id = '$gr_number'";
								...
								<!-- <a class="btn btn-danger" onclick="return confirmDel()" href="CUD/delete_item_gr.php?delID=<?php echo $row2['line_item_mm_id'];?>">
...
<!--									<input type="submit" name="insert" id="insert" value="Insert" class="btn btn-success" />-->
									<a href="CUD/item_gr.php?id=<?= $row['material_number'] ?>&rfq_number=<?= $rfq_number ?>" class="btn btn-info" id="insert_mat" type="button">Insert</a>
