<?php
    ...
    $_SESSION['po_qty']=0;
    $po_number="INV$rfq_number";
    $qt_number="PO$rfq_number";
...
<script language="javascript">
	...
	if(strPage == "page1")
	{
	document.form1.action="CUD/create_inv_mm_doc.php";
	}
...
<a href="mm_invoice_pre.php?id=<?= $vendor_id ?>" class="btn btn-danger" role="button">Back</a>
...
<div class="box span12" style="margin-left: 0px;">
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Create Receipt Invoice</h2>
					</div>
					<div class="box-content"  	> 
						 ...
						 <div class="form-group">
							 ...
							 <br/>
							 <label for="usr">Invoice number : <input type="text" class="form-control" value="<?= $po_number ?>" disabled  >
							...
							<label for="usr">PO number : <input type="text" class="form-control" value="<?= $qt_number ?>" disabled  >
						...
						<p></p>
						 ...
						 <div class="form-group">
							 ...
							 <label for="usr">
								...
								<input type="hidden" name="request" value="<?= $row4['delivery_date'] ?>" >
								&nbsp;&nbsp;&nbsp;&nbsp;
						  ...
						  <tbody>
							<?php
								...
								{ $amount=$row2['cost_price']*$row2['quantity'];	
									$net_price+=$amount;	?>
							...
							<tr>
								...
								<td>
									<form action="CUD/input_qty_po.php" method="post">
										<input type="number" name="qty" value="<?= $row2['quantity'] ?>" disabled/>
							...
							<tr>
								...
								<input type="hidden" name="net_price_mm" value="<?= $net_price ?>">
							</tr>
						  </tbody>
					  </table>            
							 </label> 
...
<!--									<input type="submit" name="insert" id="insert" value="Insert" class="btn btn-success" />-->
									<a href="CUD/item_po.php?id=<?= $row['material_number'] ?>&rfq_number=<?= $rfq_number ?>" class="btn btn-info" id="insert_mat" type="button">Insert</a>
