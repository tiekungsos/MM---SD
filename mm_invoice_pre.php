...
<!--		<button type="button" class="btn btn-primary" id="Display" value="2">Create</button>   -->
  ...
  <button type="button" class="btn btn-primary" id="Create" value="3">Display</button>   -->   
	...
	<div class="box span12" style="margin-left: 0px;">
					<form action="mm_inv_next.php" method="post">
					...
					<div class="box-content"  	> 
						<label for="usr">
							...
							<p></p>
								<button type="submit" class="btn btn-primary btn-lg" role="button" id="copyqt">Copy to Receipt Invoice</button>
				...
				<form action="mm_inv_mm_display.php" method="post">
						<input type="hidden" name="vendor_id" value="<?= $vendor_id ?>">
						<div class="box span12" style="margin-left: 0px;">
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Find Receipt Invoice</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
					...
					<div class="box-content"> 
						<div style="display: none">
						 ...
						 <div class="form-group">
							...
							<div class="form-group">
  								<label for="sel1">Invoice List:</label>
  									<select name="rfq_number" onchange="showCustomer(this.value)">
								<?php
									include("includes/connection.php");
								...
								while ($row=mysqli_fetch_array($result2))
								{ ?><!--open of while -->
									<option value="<?= $row['doc_mm_id'] ?>">INV<?= $row['doc_mm_id'] ?></option>
								<?php } ?>
								</select> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  ...
		  <table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn glyphicon glyphicon-ok" id="add_customer" href="mm_invoice_pre.php?id=<?= $row['vendor_id'] ?>" >
