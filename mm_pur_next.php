	...
	<div class="row-fluid sortable">		
				 <div class="box span12">
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span> Purchase Order </h2>
					</div>
					<div class="box-content"  	> 
		
						<p></p>
						 <label for="usr">
						<h2>Purchase Order Number : PR125868</h2>
						<h2>Document Date : 05-11-2017</h2>
						<p> </p>
						<p> </p>
						</label>
						<p></p>
		...
		<input class="form-control" id="disabledInput" type="text" placeholder="Acer" disabled> 
						  ...
						  <tbody>
							...
							?>
							 ...
							 <a href="mm_pur.php" class="btn btn-info" role="button">Black</a>
							 <a href="mm_pur.php" class="btn btn-info" role="button" id="submit">Submit</a>
						</div>
						<script>
					$(document).ready(function(){
    				$("#submit").click(function(){
								alert("The Purchase has been sent successfully.");
    				});
					});
</script>
