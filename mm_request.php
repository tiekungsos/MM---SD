...
<script language="javascript">
	...
	if(strPage == "page2")
	{
	document.form1.action="CUD/input_qty_rfq.php";
	}
...
<div class="box span12" style="margin-left: 0px;">
					<div class="box-header" data-original-title;>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Request for Quotation</h2>
						<div class="box-icon">
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Create RFQ</h2>
					</div>
						 ...
						 <div class="form-group">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td>
									<form action="CUD/input_qty_rfq.php" method="post">
								...
								<td><a class="btn btn-danger" onclick="return confirmDel()" href="CUD/delete_item_rfq.php?delID=<?php echo $row2['line_item_mm_id'];?>">
...
<!--									<input type="submit" name="insert" id="insert" value="Insert" class="btn btn-success" />-->
									<a href="CUD/item_rfq.php?id=<?= $row['material_number'] ?>&rfq_number=<?= $rfq_number ?>" class="btn btn-info" id="insert_mat" type="button">Insert</a>
