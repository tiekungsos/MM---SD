...
<script language="javascript">
	...
	if(strPage == "page1")
	{
	document.form1.action="CUD/create_po_doc.php";
	}
...
<div class="box span12" style="margin-left: 0px;">
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Create Purchase Order</h2>
					</div>
					<div class="box-content"  	> 
						 ...
						 <div class="form-group">
							...
							<label for="usr">QT number : <input type="text" class="form-control" value="<?= $qt_number ?>" disabled  >
						 ...
						 <div class="form-group">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td>EA</td>
								<td><a class="btn btn-danger" onclick="return confirmDel()" href="CUD/delete_item_po.php?delID=<?php echo $row2['line_item_mm_id'];?>">
