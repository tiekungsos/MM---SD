...
<!--		<button type="button" class="btn btn-primary" id="Display" value="2">Create</button>   -->
  <a href="mm_before_rfq.php?id=<?= $vendor_id ?>" class="btn btn-danger" role="button">Back</a>
	...
	<p></p>
				...
				<div class="box-content" id="content2" style="margin-left: 0px;" 	> 
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Display RFQ</h2>
					</div>
					<div class="box-content" 	> 
						 ...
						 <div class="form-group">
							...
							<label for="usr">RFQ number : <input type="text" class="form-control" value="<?= $_SESSION["rfq_number"] ?>" disabled  >
...
<!--					  Change -->
						...
						<div class="box span12">
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Change RFQ</h2>
					</div>
					<div class="box-content"  	> 
						 ...
						 <div class="form-group">
							 ...
							 <label for="usr">Vendor id : <input type="text" class="form-control" value="<?= $vendor_id ?>" name="vendor_id" id="cusnum" disabled>
								 ...
								 <input type="text" class="form-control" value="<?= $vendor_id ?>" name="vendor_id" id="cusnum" >
								 </div>
							 	<?php   
								include("includes/connection.php");
								$sql4 = "SELECT * FROM vendor WHERE vendor_id = '$vendor_id'";
						 ...
						 <div class="form-group">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td><?= $row2['description'] ?></td>
								<td>
									<form action="CUD/input_qtychange_mm.php" method="post">
								...
								<td><?= $row2['unit_type'] ?></td>
								<td><a class="btn btn-danger" onclick="return confirmDel()" href="CUD/delete_item_rfqchange.php?delID=<?php echo $row2['line_item_mm_id'];?>">
...
<!--									<input type="submit" name="insert" id="insert" value="Insert" class="btn btn-success" />-->
									<a href="CUD/item_rfq_change.php?id=<?= $row['material_number'] ?>&rfq_number=<?= $rfq_number ?>" class="btn btn-info" id="insert_mat" type="button">Insert</a>
