...
<script language="javascript">
	...
	if(strPage == "page2")
	{
	document.form1.action="CUD/input_qty_qtchange_sd.php";
	}
...
<!--		<button type="button" class="btn btn-primary" id="Display" value="2">Create</button>   -->
  <a href="sd_qt.php?id=<?= $custo_id ?>" class="btn btn-danger" role="button">Back</a>
					...
					<div class="box-content"  	> 
						...
						<p> </p>
						 ...
						 <div class="form-group">
							 ...
							 <?php   
								include("includes/connection.php");
								$sql3 = "SELECT * FROM document WHERE doc_id = '$qt_id'";
								$result3=mysqli_query($connect,$sql3);
								$row3=mysqli_fetch_array($result3);
								?>
							 <label for="usr">
								Requested Date :<input type="text" class="form-control" id="Requested" disabled 
								placeholder="<?= $row3['request_date'] ?>">
								&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<p> </p>
						 ...
						 <div class="form-group">
							 ...
							 <?php   
								...
								?>
							 <label for="usr">
								Requested Date :<input type="date" class="form-control" id="Requested" 
								value="<?= $row3['request_date'] ?>" name="request">
								&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<table class="table table-striped table-bordered  bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td><?= $row2['description'] ?></td>
								<td>
									<form action="CUD/input_qty_qtchange_sd.php" method="post">
										<input style="width: 120px;" type="number" name="qty" value="<?= $row2['quantity'] ?>" />
