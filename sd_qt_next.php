...
<script language="javascript">
	...
	if(strPage == "page2")
	{
	document.form1.action="CUD/input_qty_qt.php";
	}
...
<a href="sd_qt.php?id=<?= $custo_id ?>" class="btn btn-danger" role="button">Back</a>
	...
	<p></p>
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Create Quotation</h2>
					</div>
						...
						<p> </p>
						 ...
						 <div class="form-group">
							 ...
							 <label for="usr">
							  ...
							  <label for="usr">
								Inquiry number   &nbsp; &nbsp;  : <input type="text" class="form-control" id="cusnum" disabled placeholder="<?= $inq_id ?>">   
							 </label> 
							<label for="usr">
						 ...
						 <div class="form-group">
							 ...
							 <label for="usr">
								...
								value="<?= $row3['request_date'] ?>" disabled >
								 
								
								 
								<input type="hidden" name="request" value="<?= $row3['request_date'] ?>">
								&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<table class="table table-striped table-bordered  bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td><!-- <?= $row2['quantity'] ?> -->
									<form action="CUD/input_qty_qt.php" method="post">
