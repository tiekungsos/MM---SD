...
-->
	   			...
	   			<div class="box span12" style="margin-left: 0px;">
	   				<form action="sd_sale_next.php" method="post">
					...
					<div class="box-content"  	> 
						<label for="usr">
							...
							<p></p>
								<button type="submit" class="btn btn-primary btn-lg" role="button" id="copyqt">Copy to Sale order</button>
					...
					<form action="sd_so_display.php" method="post">
						<div style="display: none">
		  ...
		  <table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									<a class="btn glyphicon glyphicon-ok" id="add_customer" href="sd_sale.php?id=<?= $row['customer_id'] ?>" >
