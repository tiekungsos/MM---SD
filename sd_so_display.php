	...
	<p></p>
				...
				<div class="box-content" id="content4" style="margin-left: 0px;" 	> 
					...
					<div class="box-header" data-original-title;>
						<h2><i class="icon-file white user"></i><span class="break"></span>Display Sale order</h2>
					</div>
						...
						<p> </p>
						 ...
						 <div class="form-group">
							 ...
							 <label for="usr">
							  ...
							  <label for="usr">
								Quotation number   &nbsp; &nbsp;  : <input type="text" class="form-control" id="cusnum" disabled placeholder="<?= $qt_id ?>">   
							 </label> 
							<label for="usr">
